    ...
    <section ref={ref} className="relative mb-60 mt-20 lg:mt-32">
      ...
      <div className="flex justify-around mb-20">
        <div className="relative overflow-hidden h-fit border-[18px] border-white">
          ...
          />
          <div className="absolute bottom-3 left-3 lg:left-5 font-semibold text-white flex flex-col gap-y-1 lg:gap-y-3 inset-x-0 leading-4">
            <p className="text-lg lg:text-2xl">Arisandi S. J.</p>
        ...
        <div className="relative overflow-hidden h-fit border-[18px] border-white">
          ...
          />
          <div className="absolute bottom-3 left-3 lg:left-5 font-semibold text-white flex flex-col gap-y-1 lg:gap-y-3 inset-x-0 leading-4">
            <p className="text-lg lg:text-2xl">I. Pandu P.</p>
