...
const Hero = () => {
  return (
    <section className="mx-auto my-32 max-w-4xl text-center">
      ...
      <p className="text-xs mx-5 lg:text-sm text-[#898989] font-light mt-3">If you need a modern, interactive, and eye catching application. You’re in the right place</p>
